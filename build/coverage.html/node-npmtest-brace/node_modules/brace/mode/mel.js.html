...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/mel.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/mel.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; mel.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">ace.define("ace/mode/mel_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var MELHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(MELHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.MELHighlightRules = MELHighlightRules;</span>
});
&nbsp;
...
&nbsp;
ace.define("ace/mode/mel",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/mel_highlight_rules","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("./text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var MELHighlightRules = acequire("./mel_highlight_rules").MELHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = MELHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/mel";</span>
}).call(Mode.prototype);
&nbsp;
