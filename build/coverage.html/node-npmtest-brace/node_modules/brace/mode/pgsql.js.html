...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/pgsql.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/pgsql.js</span></h1>
    <h2>
        
        Statements: <span class="metric">5.88% <small>(9 / 153)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">5.88% <small>(9 / 153)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; pgsql.js</div>
</div>
<div class="body">
...
1489
1490
1491</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
&nbsp;
ace.define("ace/mode/perl_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextHighlightRules = acequire("./text_highlight_rules").TextHighlightRules;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var PerlHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var buildinConstants = ("ARGV|ENV|INC|SIG");</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(PerlHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.PerlHighlightRules = PerlHighlightRules;</span>
});
&nbsp;
ace.define("ace/mode/python_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextHighlightRules = acequire("./text_highlight_rules").TextHighlightRules;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var PythonHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var keywords = (</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var strPre = "(?:r|u|ur|R|U|UR|Ur|uR)?";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var decimalInteger = "(?:(?:[1-9]\\d*)|(?:0))";</span>
<span class="cstat-no" title="statement not covered" >    var octInteger = "(?:0[oO]?[0-7]+)";</span>
<span class="cstat-no" title="statement not covered" >    var hexInteger = "(?:0[xX][\\dA-Fa-f]+)";</span>
<span class="cstat-no" title="statement not covered" >    var binInteger = "(?:0[bB][01]+)";</span>
<span class="cstat-no" title="statement not covered" >    var integer = "(?:" + decimalInteger + "|" + octInteger + "|" + hexInteger + "|" + binInteger + ")";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var exponent = "(?:[eE][+-]?\\d+)";</span>
...
<span class="cstat-no" title="statement not covered" >    var exponentFloat = "(?:(?:" + pointFloat + "|" +  intPart + ")" + exponent + ")";</span>
<span class="cstat-no" title="statement not covered" >    var floatNumber = "(?:" + exponentFloat + "|" + pointFloat + ")";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var stringEscape =  "\\\\(x[0-9A-Fa-f]{2}|[0-7]{3}|[\\\\abfnrtv'\"]|U[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})";</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.$rules = {</span>
        "start" : [ {
            token : "comment",
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(PythonHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.PythonHighlightRules = PythonHighlightRules;</span>
});
&nbsp;
ace.define("ace/mode/json_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextHighlightRules = acequire("./text_highlight_rules").TextHighlightRules;</span>
...
&nbsp;
ace.define("ace/mode/pgsql_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules","ace/mode/perl_highlight_rules","ace/mode/python_highlight_rules","ace/mode/json_highlight_rules","ace/mode/javascript_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var lang = acequire("../lib/lang");</span>
<span class="cstat-no" title="statement not covered" >var DocCommentHighlightRules = acequire("./doc_comment_highlight_rules").DocCommentHighlightRules;</span>
<span class="cstat-no" title="statement not covered" >var TextHighlightRules = acequire("./text_highlight_rules").TextHighlightRules;</span>
<span class="cstat-no" title="statement not covered" >var PerlHighlightRules = acequire("./perl_highlight_rules").PerlHighlightRules;</span>
<span class="cstat-no" title="statement not covered" >var PythonHighlightRules = acequire("./python_highlight_rules").PythonHighlightRules;</span>
<span class="cstat-no" title="statement not covered" >var JsonHighlightRules = acequire("./json_highlight_rules").JsonHighlightRules;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var PgsqlHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    var keywords = (</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var sqlRules = [{</span>
...
<span class="cstat-no" title="statement not covered" >    this.embedRules(PerlHighlightRules, "perl-", [{token : "string", regex : "\\$perl\\$", next : "statement"}]);</span>
<span class="cstat-no" title="statement not covered" >    this.embedRules(PythonHighlightRules, "python-", [{token : "string", regex : "\\$python\\$", next : "statement"}]);</span>
<span class="cstat-no" title="statement not covered" >    this.embedRules(JsonHighlightRules, "json-", [{token : "string", regex : "\\$json\\$", next : "statement"}]);</span>
<span class="cstat-no" title="statement not covered" >    this.embedRules(JavaScriptHighlightRules, "javascript-", [{token : "string", regex : "\\$(js|javascript)\\$", next : "statement"}]);</span>
};
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(PgsqlHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.PgsqlHighlightRules = PgsqlHighlightRules;</span>
});
&nbsp;
ace.define("ace/mode/pgsql",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/pgsql_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("../mode/text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var PgsqlHighlightRules = acequire("./pgsql_highlight_rules").PgsqlHighlightRules;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = PgsqlHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >        if (state == "start" || state == "keyword.statementEnd") {</span>
<span class="cstat-no" title="statement not covered" >            return "";</span>
        } else {
<span class="cstat-no" title="statement not covered" >            return this.$getIndent(line); </span>// Keep whatever indent the previous line has
        }
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/pgsql";</span>
}).call(Mode.prototype);
&nbsp;
