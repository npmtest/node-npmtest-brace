...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/autohotkey.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/autohotkey.js</span></h1>
    <h2>
        
        Statements: <span class="metric">2.52% <small>(3 / 119)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; autohotkey.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">ace.define("ace/mode/autohotkey_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var AutoHotKeyHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    var autoItKeywords = 'And|ByRef|Case|Const|ContinueCase|ContinueLoop|Default|Dim|Do|Else|ElseIf|EndFunc|EndIf|EndSelect|EndSwitch|EndWith|Enum|Exit|ExitLoop|False|For|Func|Global|If|In|Local|Next|Not|Or|ReDim|Return|Select|Step|Switch|Then|To|True|Until|WEnd|While|With|' +       </span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >AutoHotKeyHighlightRules.metaData = { name: 'AutoHotKey',</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(AutoHotKeyHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.AutoHotKeyHighlightRules = AutoHotKeyHighlightRules;</span>
});
&nbsp;
...
&nbsp;
ace.define("ace/mode/autohotkey",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/autohotkey_highlight_rules","ace/mode/folding/cstyle"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("./text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var AutoHotKeyHighlightRules = acequire("./autohotkey_highlight_rules").AutoHotKeyHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = AutoHotKeyHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/autohotkey";</span>
}).call(Mode.prototype);
&nbsp;
