...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/powershell.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/powershell.js</span></h1>
    <h2>
        
        Statements: <span class="metric">2.48% <small>(4 / 161)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; powershell.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">ace.define("ace/mode/powershell_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var PowershellHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
...
<span class="cstat-no" title="statement not covered" >    var binaryOperatorsRe = (</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(PowershellHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.PowershellHighlightRules = PowershellHighlightRules;</span>
});
&nbsp;
...
&nbsp;
ace.define("ace/mode/powershell",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/powershell_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("./text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var PowershellHighlightRules = acequire("./powershell_highlight_rules").PowershellHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = PowershellHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.foldingRules = new CStyleFoldMode({start: "^\\s*(&lt;#)", end: "^[#\\s]&gt;\\s*$"});</span>
};
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/powershell";</span>
}).call(Mode.prototype);
&nbsp;
