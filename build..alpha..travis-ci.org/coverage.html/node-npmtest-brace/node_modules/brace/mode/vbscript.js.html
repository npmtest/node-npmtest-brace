...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/vbscript.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/vbscript.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; vbscript.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">ace.define("ace/mode/vbscript_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var VBScriptHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(VBScriptHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.VBScriptHighlightRules = VBScriptHighlightRules;</span>
});
&nbsp;
ace.define("ace/mode/vbscript",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/vbscript_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("./text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var VBScriptHighlightRules = acequire("./vbscript_highlight_rules").VBScriptHighlightRules;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = VBScriptHighlightRules;</span>
...
<span class="cstat-no" title="statement not covered" >    this.lineCommentStart = ["'", "REM"];</span>
    
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/vbscript";</span>
}).call(Mode.prototype);
&nbsp;
