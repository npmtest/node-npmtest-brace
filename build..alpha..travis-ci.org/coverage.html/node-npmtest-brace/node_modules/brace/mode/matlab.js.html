...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-brace/node_modules/brace/mode/matlab.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-brace/node_modules/brace/mode/matlab.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-brace/node_modules/brace/mode/</a> &#187; matlab.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">ace.define("ace/mode/matlab_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var MatlabHighlightRules = <span class="fstat-no" title="function not covered" >function() {</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >oop.inherits(MatlabHighlightRules, TextHighlightRules);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >exports.MatlabHighlightRules = MatlabHighlightRules;</span>
});
&nbsp;
ace.define("ace/mode/matlab",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/matlab_highlight_rules"], <span class="fstat-no" title="function not covered" >function(acequire, exports, module) {</span>
"use strict";
&nbsp;
<span class="cstat-no" title="statement not covered" >var oop = acequire("../lib/oop");</span>
<span class="cstat-no" title="statement not covered" >var TextMode = acequire("./text").Mode;</span>
<span class="cstat-no" title="statement not covered" >var MatlabHighlightRules = acequire("./matlab_highlight_rules").MatlabHighlightRules;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.HighlightRules = MatlabHighlightRules;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.$id = "ace/mode/matlab";</span>
}).call(Mode.prototype);
&nbsp;
